...
15. Use datatable component from Ant Design Vue
    ...
    o When Edit button is clicked, show modal to edit details. -> may use sweet alert or use component instead
    o When Delete button is clicked, ask for confirmation before 
    allowing deletion.-> use sweet alert
...
Step:
1. Framework -> tidak perlu
2. Database -> done
3. Relasi -> done
4. Authentication -> on progress
5. Middleware
6. CRUD
 a. User (buat akses login)
 a. Company
 b. Employee
7. periksa lagi
8. A/B Testing
