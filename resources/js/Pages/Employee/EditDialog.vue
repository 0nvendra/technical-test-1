                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left" v-if="data.id">
                                <form :action="route('company.update', data.id)" method="POST" @method="PUT"
                                    enctype="multipart/form-data" Accept="application/json" @submit="submitForm">
                                    <input type="hidden" name="_token" :value="csrfToken">
                                    <input type="hidden" name="_method" value="PUT">
                                    <div class="space-y-12">
                                        <div class="border-b border-gray-900/10 pb-12">
                                            <h2 class="text-base font-semibold text-gray-900">Edit Company -
                                                ...
                                                <div class="sm:col-span-4 py-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <input id="name" type="text" name="name" required
                                                            autocomplete="given-name" :value="data.name"
                                                    ...
                                                    <div class="mt-2">
                                                        <div
                                                            ...
                                                            <img id="logoPreview" alt="Preview"
                                                                class="object-cover w-full h-full" :src="data.logo" />
                                                        </div>
                                                    </div>
                                                </div>
