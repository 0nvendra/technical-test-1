                                ...
                                <form>
                                    <div class="space-y-12">
                                        <div class="border-b border-gray-900/10 pb-12">
                                            <h2 class="text-base/7 font-semibold text-gray-900">Preview Employee -
                                                {{ data.fullName }}
                                                <!-- <br>
                                                {{
                                                    data }} -->
                                            ...
                                            <div class="mt-10 grid ">
                                                <div class="sm:col-span-4 py-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <input id="firstName" type="text" name="firstName"
                                                            :value="data.firstName" readonly autocomplete="first-name"
                                                ...
                                                <div class="sm:col-span-4 py-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <input id="lastName" type="text" name="lastName"
                                                            :value="data.lastName" readonly autocomplete="last-name"
                                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sm:col-span-4 py-2 justify-center">
                                                    ...
                                                    <div class="mt-2">
                                                        <select name="company_id" id="company_id" disabled
                                                            ...
                                                            <option selected value="">{{ data.company?.name }} 
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sm:col-span-4 py-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <input id="email" type="email" name="email"
                                                            ...
                                                            autocomplete="email" :value="data.email" readonly
                                                ...
                                                <div class="sm:col-span-4 py-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <input id="phone" type="text" name="phone"  :value="data.phone" readonly
                                                            autocomplete="phone"
                                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                                    </div>
                                                </div>
